...
namespace GStoreWeb.DataAccess.Migrations
{
    ...
    [Migration("20230623065109_AddPaymentDueDateToOrderHeaderTable")]
    partial class AddPaymentDueDateToOrderHeaderTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GStoreWeb.Models.Company", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GStoreWeb.Models.OrderDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GStoreWeb.Models.OrderHeader", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GStoreWeb.Models.ShoppingCart", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("GStoreWeb.Models.ApplicationUser", b =>
                {
            ...
            modelBuilder.Entity("GStoreWeb.Models.OrderDetail", b =>
                {
                    b.HasOne("GStoreWeb.Models.OrderHeader", "OrderHeader")
                        .WithMany()
                        .HasForeignKey("OrderHeaderId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("GStoreWeb.Models.Product", "Product")
                        .WithMany()
            ...
            modelBuilder.Entity("GStoreWeb.Models.OrderHeader", b =>
                {
                    b.HasOne("GStoreWeb.Models.ApplicationUser", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("GStoreWeb.Models.ApplicationUser", b =>
                {
                    b.HasOne("GStoreWeb.Models.Company", "Company")
                        .WithMany()
